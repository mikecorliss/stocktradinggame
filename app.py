...
# FIXED: Removed top-level db.create_all() to prevent gunicorn worker crash
# Tables are now created safely on first request
...
def index():
    try:
        ...
        return "templates/index.html not found. Please check your Docker volume.", 404
